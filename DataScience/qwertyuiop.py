	 ...
	 <footer class="page-footer grey darken-4">
	   ...
	   <div class="col l3 s12">
	    ...
	    <div class="footer-copyright">
	      <div class="container">
	      Made by <a class="white-text text-lighten-3" href="https://jcharistech.wordpress.com">Manav Parmar</a><br/>
	      <a class="white-text text-lighten-3" href="https://jcharistech.wordpress.com">Thank you!!</a>
	      </div>
	    </div>
	  </footer>
	"""
